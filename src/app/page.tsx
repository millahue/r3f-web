    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <section className="container mx-auto px-4 py-16" aria-labelledby="hero-title">
        <div className="text-center mb-12">
          ...
          <div className="flex gap-4 justify-center" role="group" aria-label="Acciones principales">
            <Button
              size="lg"
        ...
        <section aria-labelledby="features-title">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16" role="list">
        ...
        <section aria-labelledby="instructions-title">
          <Card className="max-w-4xl mx-auto">
            <CardHeader>
              <CardTitle id="instructions-title">Instrucciones de Uso</CardTitle>
              <CardDescription>
                Cómo comenzar a desarrollar con esta configuración
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-muted p-4 rounded-lg" role="region" aria-labelledby="controls-title">
                <h3 id="controls-title" className="font-semibold mb-2">🎮 Controles 3D:</h3>
                <ul className="text-sm space-y-1 text-muted-foreground" role="list">
                  <li role="listitem">• Haz clic y arrastra para rotar la cámara</li>
                  <li role="listitem">• Usa la rueda del mouse para hacer zoom</li>
                  <li role="listitem">• Haz clic en los cubos para interactuar</li>
                  <li role="listitem">• Mantén presionado y arrastra para mover la vista</li>
                </ul>
              </div>
              <div className="bg-muted p-4 rounded-lg" role="region" aria-labelledby="commands-title">
                <h3 id="commands-title" className="font-semibold mb-2">🚀 Comandos de Desarrollo:</h3>
                <ul className="text-sm space-y-1 text-muted-foreground font-mono" role="list">
                  <li role="listitem">
                    •{" "}
